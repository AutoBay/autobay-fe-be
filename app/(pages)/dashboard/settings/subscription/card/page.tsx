...
const FormSchema = z
  .object({
    cardholderName: z.string().min(2, "Cardholder name must be at least 2 characters").max(50, "Cardholder name must be less than 50 characters"),
      ...
      <Form {...form}>
        <form className="space-y-6" onSubmit={form.handleSubmit(onSubmit)}>
          ...
          <div className="space-y-4">
            <Button className="w-full" disabled={!(form.formState.isValid && isCardValid)} type="submit">
