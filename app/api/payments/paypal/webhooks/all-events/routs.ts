...
export async function POST(req: NextRequest) {
  ...
  // Basic guardrails
  if (!(transmissionId && transmissionTime && certUrl && transmissionSig && serverConfig.paypal.webhooks.allEvents)) {
  ...
  const message = `${transmissionId}|${transmissionTime}|${serverConfig.paypal.webhooks.allEvents}|${crc}`;
