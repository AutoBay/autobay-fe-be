...
export async function POST(req: NextRequest) {
  ...
  // Basic guardrails
  if (!(transmissionId && transmissionTime && certUrl && transmissionSig && serverConfig.paypal.webhooks.customerPayout)) {
  ...
  const message = `${transmissionId}|${transmissionTime}|${serverConfig.paypal.webhooks.customerPayout}|${crc}`;
